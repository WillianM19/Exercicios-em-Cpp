...
A  matriz  A  deve  ser  formada  por  valores  divisíveis  por  3  ou  4,  enquanto  a 
matriz  B  deve  ser  formada  por  valores  divisíveis  por  5  e  6. - ok
...
dos elementos da matriz A com os elementos correspondentes da matriz B. - ok  */
...
int main(){
    ...
    cout << "\nMatriz C(Multiplicação de A e B): \n\n";
    for (int i = 0; i < 4; i++){ //C
        for (int j = 0; j < 5; j++){
            cout << C[i][j] << "\t";
        }
